...
public class Task03b_IMPORT_API {
    ...
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        ...
        final String containerKey = "cn-berlin-store-prices";
        ...
        logger.info("Created price resource {} ",
                    importService.createPriceImportRequest(containerKey, "tulip-seed-product", "TULIPSEED02", "TulipSeed02Price01", amount)
                        .get()
        );
